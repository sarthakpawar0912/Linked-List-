...
//        list.insertFirst(3);  // List: 3
//        list.insertFirst(5);  // List: 5 -> 3
//        list.insertFirst(8);  // List: 8 -> 5 -> 3
//        list.insertFirst(9);  // List: 9 -> 8 -> 5 -> 3
//        list.insertFirst(18); // List: 18 -> 9 -> 8 -> 5 -> 3
//
//        // Insert elements at the end
//        list.insertLast(99);  // List: 18 -> 9 -> 8 -> 5 -> 3 -> 99
//        list.insertLast(66);  // List: 18 -> 9 -> 8 -> 5 -> 3 -> 99 -> 66
//
//        // Insert 65 after the first occurrence of 66
//        list.insert(66, 65);  // List: 18 -> 9 -> 8 -> 5 -> 3 -> 99 -> 66 -> 65
//
...
//        list.insert(23);  // List: 23 (circular: 23 -> 23)
//        list.insert(3);   // List: 23 -> 3 (circular: 3 -> 23)
//        list.insert(34);  // List: 23 -> 3 -> 34 (circular: 34 -> 23)
//        list.insert(67);  // List: 23 -> 3 -> 34 -> 67 (circular: 67 -> 23)
//        list.insert(98);  // List: 23 -> 3 -> 34 -> 67 -> 98 (circular: 98 -> 23)
//        list.insert(11);  // List: 23 -> 3 -> 34 -> 67 -> 98 -> 11 (circular: 11 -> 23)
//
//        list.display();
//
//        list.delete(98);
